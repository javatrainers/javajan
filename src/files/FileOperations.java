...
public class FileOperations extends Thread{
	...
	public static void main(String ar[]) throws IOException
	{
		...
		FileWriter print= new FileWriter(writef)  ; // initialize File writer
		//BufferedWriter print= new BufferedWriter( new FileWriter(writef)  ); // initialize File writer
		print.write("Hello i am learning how to write text in file using java");			// write string content on this file
...
//		readFile.rea
		...
		BufferedReader readFile = new BufferedReader(new FileReader(fileCompletePath)); 
